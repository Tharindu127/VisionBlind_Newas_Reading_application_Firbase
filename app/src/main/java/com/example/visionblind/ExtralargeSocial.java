...
public class ExtralargeSocial extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_extralarge_social);
        ...
        extraLargeRecyclerView = findViewById(R.id.extralarge_social_recycler);
        extraLargeFirebaseDatabase= FirebaseDatabase.getInstance();
        extraLargeDatabaseReference = extraLargeFirebaseDatabase.getReference("SocialNews");
