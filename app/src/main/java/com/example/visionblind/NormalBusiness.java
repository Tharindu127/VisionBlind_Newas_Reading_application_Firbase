...
public class NormalBusiness extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_normal_business);
        ...
        normalRecyclerView = findViewById(R.id.normal_business_recycler);
        normalFirebaseDatabase = FirebaseDatabase.getInstance();
        normalDatabaseReference = normalFirebaseDatabase.getReference("BusinessNews");
