...
public class LargeForeign extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_large_foreign);
        ...
        largeRecyclerView = findViewById(R.id.large_foreign_recycler);
        largeFirebaseDatabase = FirebaseDatabase.getInstance();
        largeDatabaseReference = largeFirebaseDatabase.getReference("ForeignNews");
