...
public class ExtralargeSports extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_extralarge_sports);
        ...
        extraLargeRecyclerView = findViewById(R.id.extralarge_sports_recycler);
        extraLargeFirebaseDatabase= FirebaseDatabase.getInstance();
        extraLargeDatabaseReference = extraLargeFirebaseDatabase.getReference("SportsNews");
