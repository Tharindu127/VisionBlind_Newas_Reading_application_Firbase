...
public class ForeignNews extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        completeRecyclerView = findViewById(R.id.complete_foreign_recycler);
        completeFirebaseDatabase = FirebaseDatabase.getInstance();
        completeDatabaseReference = completeFirebaseDatabase.getReference("ForeignNews");
    ...
    private void showData() {
        ...
        firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Model, CompleteBlindViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull CompleteBlindViewHolder holder, int position, @NonNull Model model) {
                holder.setDetails(getApplicationContext(), model.getImage(), model.getHeadline(), model.getDate(), model.getPicDescription(), model.getDescription(), model.getImage());
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                if(i == 1){
                                    ...
                                    Toast.makeText(ForeignNews.this, "Reading Headline", Toast.LENGTH_LONG).show();
                                    String s = "Reading Headline :" + passHeadline + "date :" + passDate + "time:" + passTime + "double tap to go to the news";
                                    ...
                                    Toast.makeText(ForeignNews.this, "Going to news", Toast.LENGTH_LONG).show();
