...
public class SocialNews extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        completeRecyclerView = findViewById(R.id.complete_social_recycler);
        completeFirebaseDatabase = FirebaseDatabase.getInstance();
        completeDatabaseReference = completeFirebaseDatabase.getReference("SocialNews");
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                if(i == 1){
                                    ...
                                    Toast.makeText(SocialNews.this, "Reading Headline", Toast.LENGTH_LONG).show();
                                    ...
                                    Toast.makeText(SocialNews.this, "Going to news", Toast.LENGTH_LONG).show();
