...
public class WeatherNews extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        completeRecyclerView = findViewById(R.id.complete_weather_recycler);
        completeFirebaseDatabase = FirebaseDatabase.getInstance();
        completeDatabaseReference = completeFirebaseDatabase.getReference("WeatherNews");
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                if(i == 1){
                                    ...
                                    Toast.makeText(WeatherNews.this, "Reading Headline", Toast.LENGTH_LONG).show();
                                    ...
                                    Toast.makeText(WeatherNews.this, "Going to news", Toast.LENGTH_LONG).show();
                                    String s = "Going to news :";
                                    int speech = completehotspeech.speak(s, TextToSpeech.QUEUE_FLUSH, null);
