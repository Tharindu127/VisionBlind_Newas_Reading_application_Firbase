...
public class SmallWeather extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_small_weather);
        ...
        hotRecyclerView = findViewById(R.id.small_weather_recycler);
        hotFirebaseDatabase = FirebaseDatabase.getInstance();
        hotDatabaseReference = hotFirebaseDatabase.getReference("WeatherNews");
