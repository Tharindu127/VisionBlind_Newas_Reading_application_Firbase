...
public class ExtralargeHot extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_extralarge_hot);
        ...
        extraLargeRecyclerView = findViewById(R.id.extralarge_hot_recycler);
        extraLargeFirebaseDatabase= FirebaseDatabase.getInstance();
        extraLargeDatabaseReference = extraLargeFirebaseDatabase.getReference("HotNews");
