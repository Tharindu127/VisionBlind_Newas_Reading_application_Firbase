...
public class SmallForeign extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_small_foreign);
        ...
        hotRecyclerView = findViewById(R.id.small_foreign_recycler);
        hotFirebaseDatabase = FirebaseDatabase.getInstance();
        hotDatabaseReference = hotFirebaseDatabase.getReference("ForeignNews");
