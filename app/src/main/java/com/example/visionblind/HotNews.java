...
public class HotNews extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        completeRecyclerView = findViewById(R.id.complete_hot_recycler);
        completeFirebaseDatabase = FirebaseDatabase.getInstance();
        completeDatabaseReference = completeFirebaseDatabase.getReference("HotNews");
    ...
    private void showData() {
        ...
        firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Model, CompleteBlindViewHolder>(options) {
            ...
            public CompleteBlindViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                ...
                final CompleteBlindViewHolder viewHolder = new CompleteBlindViewHolder(itemView);
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                if(i == 1){
                                    ...
                                    Toast.makeText(HotNews.this, "Reading Headline", Toast.LENGTH_LONG).show();
                                    ...
                                    Toast.makeText(HotNews.this, "Going to news", Toast.LENGTH_LONG).show();
