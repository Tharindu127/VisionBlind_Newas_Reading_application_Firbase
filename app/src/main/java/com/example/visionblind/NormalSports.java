...
public class NormalSports extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_normal_sports);
        ...
        normalRecyclerView = findViewById(R.id.normal_sports_recycler);
        normalFirebaseDatabase = FirebaseDatabase.getInstance();
        normalDatabaseReference = normalFirebaseDatabase.getReference("SportsNews");
