...
public class ExtralargeWeather extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_extralarge_weather);
        ...
        extraLargeRecyclerView = findViewById(R.id.extralarge_weather_recycler);
        extraLargeFirebaseDatabase= FirebaseDatabase.getInstance();
        extraLargeDatabaseReference = extraLargeFirebaseDatabase.getReference("WeatherNews");
