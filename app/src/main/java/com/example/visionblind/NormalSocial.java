...
public class NormalSocial extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_normal_social);
        ...
        normalRecyclerView = findViewById(R.id.normal_social_recycler);
        normalFirebaseDatabase = FirebaseDatabase.getInstance();
        normalDatabaseReference = normalFirebaseDatabase.getReference("SocialNews");
