...
public class LargeBusiness extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_large_business);
        ...
        largeRecyclerView = findViewById(R.id.large_business_recycler);
        largeFirebaseDatabase = FirebaseDatabase.getInstance();
        largeDatabaseReference = largeFirebaseDatabase.getReference("BusinessNews");
