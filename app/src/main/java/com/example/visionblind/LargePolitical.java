...
public class LargePolitical extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_large_political);
        ...
        largeRecyclerView = findViewById(R.id.large_political_recycler);
        largeFirebaseDatabase = FirebaseDatabase.getInstance();
        largeDatabaseReference = largeFirebaseDatabase.getReference("PoliticalNews");
