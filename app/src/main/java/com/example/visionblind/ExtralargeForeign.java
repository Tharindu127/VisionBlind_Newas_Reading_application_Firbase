...
public class ExtralargeForeign extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_extralarge_foreign);
        ...
        extraLargeRecyclerView = findViewById(R.id.extralarge_foreign_recycler);
        extraLargeFirebaseDatabase= FirebaseDatabase.getInstance();
        extraLargeDatabaseReference = extraLargeFirebaseDatabase.getReference("ForeignNews");
