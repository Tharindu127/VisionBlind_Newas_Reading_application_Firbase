...
public class LargeWeather extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_large_weather);
        ...
        largeRecyclerView = findViewById(R.id.large_weather_recycler);
        largeFirebaseDatabase = FirebaseDatabase.getInstance();
        largeDatabaseReference = largeFirebaseDatabase.getReference("WeatherNews");
