...
public class SmallSocial extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_small_social);
        ...
        hotRecyclerView = findViewById(R.id.small_social_recycler);
        hotFirebaseDatabase = FirebaseDatabase.getInstance();
        hotDatabaseReference = hotFirebaseDatabase.getReference("SocialNews");
