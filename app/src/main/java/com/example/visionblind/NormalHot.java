...
public class NormalHot extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_normal_hot);
        ...
        normalRecyclerView = findViewById(R.id.normal_recycler);
        normalFirebaseDatabase = FirebaseDatabase.getInstance();
        normalDatabaseReference = normalFirebaseDatabase.getReference("HotNews");
