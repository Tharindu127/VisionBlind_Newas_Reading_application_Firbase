...
public class ExtralargePolitical extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_extralarge_political);
        ...
        extraLargeRecyclerView = findViewById(R.id.extralarge_political_recycler);
