...
public class SportsNews extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        completeRecyclerView = findViewById(R.id.complete_sports_recycler);
        completeFirebaseDatabase = FirebaseDatabase.getInstance();
        completeDatabaseReference = completeFirebaseDatabase.getReference("SportsNews");
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                if(i == 1){
                                    ...
                                    Toast.makeText(SportsNews.this, "Reading Headline", Toast.LENGTH_LONG).show();
                                    ...
                                    Toast.makeText(SportsNews.this, "Going to news", Toast.LENGTH_LONG).show();
