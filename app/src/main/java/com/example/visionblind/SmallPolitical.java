...
public class SmallPolitical extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_small_political);
        ...
        hotRecyclerView = findViewById(R.id.small_political_recycler);
        hotFirebaseDatabase = FirebaseDatabase.getInstance();
        hotDatabaseReference = hotFirebaseDatabase.getReference("PoliticalNews");
